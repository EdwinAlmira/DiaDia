   ...
   <div id="grafico2"></div>
    <script type="text/javascript">
      ...
      function drawChart() {
        ...
        $alumfi = Database::getRow($sql1, null);
        $sql2 = "SELECT COUNT(DISTINCT Id_producto) from carritos where estadoCarrito = 2";
        $alumsi = Database::getRow($sql2, null);
       	$alumno3 = $alumfi[0] - $alumsi[0];        
   ...
   <div id="grafico5"></div>
    <script type="text/javascript">
      ...
      function drawChart() {
        ...
        //Se agregan las filas
        <?php
        $sql1 = "SELECT COUNT(*) from bitacoras WHERE Id_accion=1 ";
        $alumfi = Database::getRow($sql1, null);
        $sql2 = "SELECT COUNT(*) from bitacoras WHERE Id_accion=3"; 
        $alumsi = Database::getRow($sql2, null);
       	$sql3 = "SELECT COUNT(*) from bitacoras WHERE Id_accion=4";        
        $alumno3 = Database::getRow($sql3, null);
        $sql4 = "SELECT COUNT(*) from bitacoras WHERE Id_accion=5";        
        $alumno4 = Database::getRow($sql4, null);
        ...
        ?>
        // Se definen las opciones del grafico
        var options = {'title':'Acciones más ejecutadas en el sistema',
				        is3D: true,
				        pieHole: 0.4,
                       'width':900,
                       'height':250,
