              ...
              <ul class="nav navbar-nav navbar-right">
                ...
                <li  class="dropdown fuente">
                  ...
                  <ul class="dropdown-menu">
                    <li class="fuente"><a href="views/ecopet.php">ECO-PET</a></li>
                    <li class="fuente"><a href="views/hogar.php">HOGAR</a></li>
                    <li class="fuente"><a href="#">OFICINAS</a></li>
                    <li class="fuente"><a href="views/bodas.php">BODAS</a></li>
                    <li class="fuente"><a href="views/decoracion.php">DECORACIÓN</a></li>
                  </ul>
                </li>

                <!-- dropdown de blog -->
                <li class="fuente"><a href="views/blog.php" role="button">BLOG</a>
                </li>
                <li class="fuente"><a href="views/GALERIA.php" role="button">GALERÍA DE PROYECTOS</a>
                </li>
                ...
                <li class="dropdown fuente">
                  ...
                  <ul class="dropdown-menu">
                    ...
                    <li class="fuente"><a href="views/ask.php">PREGUNTAS FRECUENTES</a></li>
                  </ul>
                </li>
        ...
        if ($now > $_SESSION['expire']) {
            session_destroy();
                  ...
                  <ul class='dropdown-menu'>
                    ...
                    <li class='fuente'><a href='views/compra.php'><span class='glyphicon glyphicon-shopping-cart'></span> VER CARRITO DE COMPRA</a></li>
                    <li class='fuente'><a href='views/rec.php?id'><span class='glyphicon glyphicon-book'></span> VER TUS COTIZACIONES</a></li>
                    <li class='fuente'><a href='views/logoutcliente.php'><span class='glyphicon glyphicon-remove'></span> CERRAR SESION</a></li>
                  </ul>
                </li>"); 
                                ...
                                echo "<a class='fuente' href='views/login.php'></i><span class='glyphicon glyphicon-user'></span> INICIAR SESION</a><br>";
                            }                            
                        ?> 
                        </li>
...
var notification = new NotificationFx({
  ...
  // the message
  message : '<img src="img/logos/blancosmall.png" align="left"><h4 class="fuente"> <br>&nbsp&nbspLA CARPINTERIA SV</h4><br><br><span class="text-center">&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp &nbsp  BIENVENIDO A LA CARPINTERIA SV!&nbsp&nbsp&nbsp</span><br><br><butt type="button"  class="btn btn-hola fuente ">Visita nuestro catalogo de productos&nbsp&nbsp&nbsp&nbsp <span class="glyphicon glyphicon-list-alt" aria-hidden="true"></span></button>',
...
$sql = "SELECT imagenBlog,titulo,id_blog, (SUBSTRING(cuerpo,1, 183)) AS EDWIN FROM blogs WHERE estadoBlog =1";
            $params = null;
        ...
        <div class='col-md-6 portfolio-item fade1'>
                <a class='ihover left' href='views/prevblog.php?id=".base64_encode($row['id_blog'])."'>
...
$fechas = "SELECT fecha_inicio, fecha_fin FROM mesproducto WHERE  estado_mes = ?";
$params = array(1);
$datos = Database::getRow($fechas, $params); 



$sql = "SELECT productos.Id_producto, nombreProdu, miniDescrip, precio,fechaIngreso,imagen, productos.id_subcategoria,subcategorias.Id_categoria,categoria,subcategoria FROM productos, categorias, subcategorias WHERE  productos.id_subcategoria = subcategorias.id_subcategoria and subcategorias.Id_categoria=categorias.Id_categoria AND estadoProducto = 1 AND fechaIngreso between ? and ?";
            
            $params = array($datos['fecha_inicio'], $datos['fecha_fin']);
...
<div class='col-lg-3 col-md-6 col-xs-6 thumb'>
  <ul class='list-inline'> 
  <li><a  class='ihover circle2' href='#myGallery' data-slide-to='0' data-toggle='modal' data-target='#$row[Id_producto]'><img class='img-thumbnail ' src='data:image/*;base64,$row[imagen]''></a></li>
  </div>
  <!--FIN DE LAS IMAGENES NORMALES-->
</ul>
