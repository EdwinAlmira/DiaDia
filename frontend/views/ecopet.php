...
<!-- End WOWSlider.com BODY section -->
 ...
 <h1 class="text-center fuente fuentecolor"> <i>ECO-PET </i></h1><br> 
 <hr>
 </div>
	...
	<div class="container-fluid" id="principalP">
		...
		<div class="col-sm-12 col-md-offset-10 col-md-2 postz" id="barranueva">
			...
			<?php
					...
					$sql = "SELECT subcategoria, id_subcategoria from subcategorias where Id_categoria=2";
		    ...
		    ?>
                ...
                <input id='buscar' type='text' name='buscar' autocomplete="off" placeholder = 'Buscar categorías' onkeypress="return soloLetras(event)" class='validate col-md-12'/>
                <span  class=" buscar glyphicon glyphicon-search" aria-hidden="true"></span>
        ...
        ?>
			...
			<div class=" fuente col-sm-10 col-md-10 cuadricula wow slideInLeft" data-wow-offset="300"  data-wow-iteration="1">
				<div class="row">
				...
				<?php
					...
					if(!empty($_POST))
					{
						if(isset($_POST['filtrar']) and $_POST['filtrar'] == 'si'){
							...
							$sql = "SELECT productos.Id_producto, nombreProdu, miniDescrip, precio,imagen, productos.id_subcategoria, subcategorias.Id_categoria FROM productos, categorias, subcategorias WHERE productos.id_subcategoria = subcategorias.id_subcategoria and subcategorias.Id_categoria=categorias.Id_categoria AND subcategorias.Id_categoria=2 AND estadoProducto = 1 and subcategorias.id_subcategoria = ? ORDER BY nombreProdu";
							$params = array($search);
			            }
			            else{
						$search = trim($_POST['buscar']);
						$sql = "SELECT productos.Id_producto, nombreProdu, miniDescrip, precio,imagen, productos.id_subcategoria, subcategorias.Id_categoria FROM productos, categorias, subcategorias WHERE productos.id_subcategoria = subcategorias.id_subcategoria and subcategorias.Id_categoria=categorias.Id_categoria AND subcategorias.Id_categoria=2 AND estadoProducto = 1 and nombreProdu LIKE ? ORDER BY nombreProdu";
						$params = array("%$search%");
						}
					}
					else
					{
					$sql = "SELECT productos.Id_producto, nombreProdu, miniDescrip, precio,imagen , productos.id_subcategoria,subcategorias.Id_categoria FROM productos, categorias, subcategorias WHERE  productos.id_subcategoria = subcategorias.id_subcategoria and subcategorias.Id_categoria=categorias.Id_categoria AND subcategorias.Id_categoria=2 AND estadoProducto = 1 ORDER BY nombreProdu";
					$params = null;
					}
						...
						foreach ($data as $row) 
						{
							...
							<div class='col-xs-6 col-sm-4 col-md-3  text-center box'>
							  	<div class='thumbnail'>
							    			...
							    			<div class='caption'>
							      				<h3 class='text-center fuente'>$row[nombreProdu]</h3></a>
							    			</div>
