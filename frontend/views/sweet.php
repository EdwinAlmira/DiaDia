<?php 
            ...
            {
                  echo "<script>swal('ERROR ','No dejes el nombre vacio','error');</script>";
            }
            ...
            {
                  echo "<script>swal('ERROR ','Error en las claves','error');</script>";
            }
            if($permiso_alert=='clave2')
            {
                  echo "<script>swal('ERROR ','Error en las claves, no las dejes vacías y haz que coincidan1','error');</script>";
            }
