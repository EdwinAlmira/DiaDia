...
var notification = new NotificationFx({
  ...
  // the message
  message : '<img src="img/logos/blancosmall.png" align="left"><h4 class="fuente"> <br>&nbsp&nbspLA CARPINTERIA SV</h4><br><br><span class="text-center">&nbsp&nbsp&nbsp&nbsp Productos en madera 100% ecologicos.</span><br><br>',
